function ResCards({ index, restaurant,w,h }) {
    return (
        <>
            <div key={index} className="transform transition-transform duration-300 hover:scale-105 "  >
            <div style={{ width: `${w}px`, height: `${h}px` }} className="relative">
                    ...
                    <p className="absolute bottom-0 pl-[6%] pb-[5%] text-white font-bold text-[100%]">{restaurant?.info?.aggregatedDiscountInfoV3?.header + " " + restaurant?.info?.aggregatedDiscountInfoV3?.subHeader}</p>

                </div>
                <div className="mt-[5%] pl-[6%]" style={{ width: `${w}px` }}>
                    <div>
